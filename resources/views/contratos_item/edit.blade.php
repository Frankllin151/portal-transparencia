...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
  ...
  <ul class="d-flex align-items-center gap-2">
    <li class="fw-medium">
       ...
       <a href="{{route("contratos_item")}}" class="btn btn-sm btn-secondary radius-8 d-inline-flex align-items-center gap-1">
...
<div class="card">
  <div class="card-header">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
      <h6 class="card-title mb-0">Editar Item de Contrato: #{{ $data->codigo_item_contrato ?? 'N/A' }}</h6>
  ...
  <div class="card-body">
    <form action="{{ route('contratos_item.update', $data->id) }}" method="POST">
              ...
              <div class="row gy-3">
                <div class="col-12">
                  ...
                  <select name="contrato_id" id="contrato_id" class="form-control @error('contrato_id') is-invalid @enderror" required>
                    ...
                    @foreach($contratos as $contrato)
                      <option value="{{ $contrato->id }}" {{ old('contrato_id', $data->contrato_id) == $contrato->id ? 'selected' : '' }}>
                ...
                <div class="col-12">
                  ...
                  <input type="number" name="codigo_item_contrato" id="codigo_item_contrato" class="form-control @error('codigo_item_contrato') is-invalid @enderror"
                         value="{{ old('codigo_item_contrato', $data->codigo_item_contrato) }}" placeholder="Ex: 4554" required>
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="descricao_item_contrato" id="descricao_item_contrato" class="form-control @error('descricao_item_contrato') is-invalid @enderror"
                         value="{{ old('descricao_item_contrato', $data->descricao_item_contrato) }}" placeholder="Ex: Laboriosam expedita qui." required>
              ...
              <div class="row gy-3">
                <div class="col-12">
                  ...
                  <input type="number" name="quantidade" id="quantidade" class="form-control @error('quantidade') is-invalid @enderror"
                         value="{{ old('quantidade', $data->quantidade) }}" placeholder="Ex: 26" required>
                  @error('quantidade')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
