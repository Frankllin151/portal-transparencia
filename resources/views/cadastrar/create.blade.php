    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                <h6 class="card-title mb-0">Formulário de Cadastro de Usuário</h6>
            </div>
        </div>
        <div class="card-body">
                                ...
                                <div class="row gy-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                               value="{{ old('name') }}" placeholder="Ex: João da Silva" required>
                                        @error('name')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="cpf" id="cpf" class="form-control @error('cpf') is-invalid @enderror"
                                               value="{{ old('cpf') }}" placeholder="Ex: 123.456.789-00">
                                        @error('cpf')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row gy-3">
                                    <div class="col-12">
                                        ...
                                        <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror"
                                               value="{{ old('email') }}" placeholder="Ex: email@exemplo.com" required>
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="password" id="password" class="form-control @error('password') is-invalid @enderror"
                                               value="12345678" placeholder="Digite a senha" required>
                                        @error('password')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
            ...
            $(document).ready(function() {
                ...
                $('#foto').change(function() {
                    if (this.files && this.files[0]) {
                        ...
                        $('#foto-preview').attr('src', 'https://placehold.co/100x100/cccccc/000000?text=Foto'); // Placeholder se nenhum arquivo for selecionado
                    }
                });
            });
        </script>
