...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="card-body">
    ...
    <table class="table bordered-table mb-0" id="dataTableProcessosLicitacao" data-page-length='10'>
      <thead>
        <tr>
          <th>S.L</th>
      ...
      <tbody>
        ...
        @empty
          <tr>
            <td colspan="7" class="text-center">Nenhum registro de processo de licitação encontrado.</td>
          </tr>
        @endforelse
      </tbody>
    </table>
