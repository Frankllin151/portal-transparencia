      ...
      <div class="card shadow-none border bg-gradient-start-1 h-100 card-custom-hover">
        <div class="card-body p-20">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div>
              <p class="text-primary-light mb-1 fw-bold">Dispensa de Licitação</p>
              <h6 class="mb-0"></h6>
            </div>
            <div class="w-50-px h-50-px btn-info-600 rounded-circle d-flex justify-content-center align-items-center">
              <iconify-icon icon="mdi:file-cancel-outline" class="text-white text-2xl mb-0"></iconify-icon>
            </div>
          </div>
          <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
            <a href="{{ route('publico.processos.dispensa') }}" class="text-primary-main">Ver Detalhes</a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card shadow-none border bg-gradient-start-1 h-100 card-custom-hover">
        <div class="card-body p-20">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div>
              <p class="text-primary-light mb-1 fw-bold">Processos Licitatórios</p>
              <h6 class="mb-0"></h6>
            </div>
            <div class="w-50-px h-50-px btn-info-600 rounded-circle d-flex justify-content-center align-items-center">
              <iconify-icon icon="mdi:folder-file-outline" class="text-white text-2xl mb-0"></iconify-icon>
            </div>
          </div>
          <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
            <a href="{{ route('publico.processos.licitacoes') }}" class="text-primary-main">Ver Detalhes</a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card shadow-none border bg-gradient-start-1 h-100 card-custom-hover">
        <div class="card-body p-20">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div>
              <p class="text-primary-light mb-1 fw-bold">Processos Finalizados</p>
              <h6 class="mb-0"></h6>
            </div>
            <div class="w-50-px h-50-px btn-info-600 rounded-circle d-flex justify-content-center align-items-center">
          ...
          <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
            <a href="{{ route('publico.processos.finalizados') }}" class="text-primary-main">Ver Detalhes</a>
          </p>
        </div>
      </div>
    </div>
