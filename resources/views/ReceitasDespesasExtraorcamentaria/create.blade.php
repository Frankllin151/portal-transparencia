...
<!-- Novo Orçamentaria Receita Despesas-->
<div class="card">
  <div class="card-header">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
      <h6 class="card-title mb-0">Novo Registro de Receita/Despesa Extra Orçamentária</h6>
      <div class="d-flex gap-2">
        {{-- Botão de Voltar para a listagem --}}
        <a href="{{ route('despreceitaex') }}" class="btn btn-sm btn-secondary radius-8 d-inline-flex align-items-center gap-1">
  ...
  <div class="card-body">
    <form action="{{ route('despreceitaex.store') }}" method="POST">
      @csrf
      {{-- Não usamos @method('PUT') para criação, apenas para atualização --}}
    ...
    @enderror
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="descricao_classificacao" class="form-control" value="{{ old('descricao_classificacao') }}" placeholder="Ex: Detalhes da classificação">
