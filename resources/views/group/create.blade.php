  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title mb-0">Cadastro de Grupo</h5> {{-- Título do card ajustado --}}
      </div>
      <div class="card-body">
        <form action="{{ route('grupos.store') }}" method="POST" class="row gy-3 needs-validation" novalidate> {{-- Rota do formulário ajustada --}}
          @csrf
