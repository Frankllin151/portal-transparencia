...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <style>
    ...
    <body>
   <x-header></x-header>
   <x-despesas-execucao></x-despesas-execucao>
  <x-footer></x-footer>
...
<script>
  ...
  const chartLabels = valorEmpenhoTotal > 0 ? ['Valor Empenho'] : ['Nenhum Valor'];
              ...
              donut: {
                  ...
                  labels: {
                      ...
                      name: {
                          ...
                          color: undefined,
                          offsetY: -10,
                          text: 'Valor Empenho' // Texto fixo acima do valor central
                      },
                      value: {
                          show: true,
                          fontSize: '22px',
  ...
  var chart = new ApexCharts(document.querySelector("#despesasProgramas"), options);
  chart.render();
</script>
    </body>
</html>
