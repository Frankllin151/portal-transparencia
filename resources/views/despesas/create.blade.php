              ...
              <div class="row gy-3">
                <div class="col-12">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="valor_empenho" class="form-control money" placeholder="0,00">
                  </div>
                </div>
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_liquidado" class="form-control money" placeholder="0,00">
                  </div>
                </div>
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_pago" class="form-control money" placeholder="0,00">
                  </div>
                </div>
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_orcado" class="form-control money" placeholder="0,00">
                  </div>
                </div>
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_atualizado" class="form-control money" placeholder="0,00">
                  </div>
                </div>
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_alterado" class="form-control money" placeholder="0,00">
                  </div>
                </div>
              </div>
            </div>
