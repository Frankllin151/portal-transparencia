...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <style>
    ...
    <body>
   <x-header></x-header>
  <x-despesas-credor></x-despesas-credor>
  <x-footer></x-footer>
...
<script>
              ...
              donut: {
                  ...
                  labels: {
                      ...
                      name: {
                          ...
                          color: undefined,
                          offsetY: -10,
                          text: 'Total Pago' // Texto fixo acima do valor central
                      },
                      value: {
                          show: true,
                          fontSize: '22px',
  ...
  var chart = new ApexCharts(document.querySelector("#despesasCredorChart"), options);
  chart.render();
</script>
    </body>
</html>
