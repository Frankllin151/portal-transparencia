...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <style>
    ...
    <body>
   <x-header></x-header>
  <x-despesasprograma></x-despesasprograma>
  <x-footer></x-footer>
...
<script>
  ...
  const chartSeries = valorEmpenhoTotal > 0 ? [valorEmpenhoTotal] : [00]; // Se > 0, usa o valor, senão usa 1 simbólico
  const chartLabels = valorEmpenhoTotal > 0 ? ['Valor pago  Empenho'] : ['Valor pago  Empenho'];
              ...
              donut: {
                  ...
                  labels: {
                      ...
                      name: {
                          ...
                          color: undefined,
                          offsetY: -10,
                          text: 'Valor pago  Empenho' // Texto fixo acima do valor central
                      },
                      value: {
                          show: true,
                          fontSize: '22px',
  ...
  var chart = new ApexCharts(document.querySelector("#despesasProgramacaoAcaoChart"), options);
  chart.render();
</script>
    </body>
</html>
