...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
  ...
  <ul class="d-flex align-items-center gap-2">
    <li class="fw-medium">
      <a href="{{ route('receita') }}" class="btn btn-sm btn-secondary radius-8 d-inline-flex align-items-center gap-1">
              ...
              <div class="row gy-3">
                <div class="col-12">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="valor_orcado_inicial" id="valor_orcado_inicial" class="form-control money @error('valor_orcado_inicial') is-invalid @enderror" placeholder="0,00" value="{{ old('valor_orcado_inicial', $receita->valor_orcado_inicial) }}">
                  </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_orcado_atualizado" id="valor_orcado_atualizado" class="form-control money @error('valor_orcado_atualizado') is-invalid @enderror" placeholder="0,00" value="{{ old('valor_orcado_atualizado', $receita->valor_orcado_atualizado) }}">
                  </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_deducoes_orcado" id="valor_deducoes_orcado" class="form-control money @error('valor_deducoes_orcado') is-invalid @enderror" placeholder="0,00" value="{{ old('valor_deducoes_orcado', $receita->valor_deducoes_orcado) }}">
                  </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_arrecadado_mes" id="valor_arrecadado_mes" class="form-control money @error('valor_arrecadado_mes') is-invalid @enderror" placeholder="0,00" value="{{ old('valor_arrecadado_mes', $receita->valor_arrecadado_mes) }}">
                  </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_arrecadado_acumulado" id="valor_arrecadado_acumulado" class="form-control money @error('valor_arrecadado_acumulado') is-invalid @enderror" placeholder="0,00" value="{{ old('valor_arrecadado_acumulado', $receita->valor_arrecadado_acumulado) }}">
                  </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_deducoes_mes" id="valor_deducoes_mes" class="form-control money @error('valor_deducoes_mes') is-invalid @enderror" placeholder="0,00" value="{{ old('valor_deducoes_mes', $receita->valor_deducoes_mes) }}">
                  </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_lancado_mes" id="valor_lancado_mes" class="form-control money @error('valor_lancado_mes') is-invalid @enderror" placeholder="0,00" value="{{ old('valor_lancado_mes', $receita->valor_lancado_mes) }}">
                  </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-base">R$</span>
                    <input type="text" name="valor_lancado_periodo" id="valor_lancado_periodo" class="form-control money @error('valor_lancado_periodo') is-invalid @enderror" placeholder="0,00" value="{{ old('valor_lancado_periodo', $receita->valor_lancado_periodo) }}">
                  </div>
