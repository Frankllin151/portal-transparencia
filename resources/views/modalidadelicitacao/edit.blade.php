<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
           {{ __('Editar Modalidade de Licitação') }} {{-- Título do cabeçalho ajustado --}}
        </h2>
    </x-slot>
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title mb-0">Edição de Modalidade Licitação</h5> {{-- Título do card ajustado --}}
      </div>
      <div class="card-body">
        <form action="{{ route('modalidadelicitacao.update', $data->id) }}" method="POST" class="row gy-3 needs-validation" novalidate> {{-- Rota do formulário e parâmetro ajustados --}}
          @csrf
