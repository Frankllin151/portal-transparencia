      ...
      <div class="card shadow-none border bg-gradient-start-1 h-100">
        <div class="card-body p-20">
          ...
          <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
            <a href="{{ route('publico.servidores.cargos-vencimentos') }}" class="text-primary-main">Ver Detalhes</a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card shadow-none border bg-gradient-start-1 h-100">
        <div class="card-body p-20">
          ...
          <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
            <a href="{{ route('publico.servidores.remuneracoes') }}" class="text-primary-main">Ver Detalhes</a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card shadow-none border bg-gradient-start-1 h-100">
        <div class="card-body p-20">
          ...
          <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
            <a href="{{ route('publico.servidores.publicos') }}" class="text-primary-main">Ver Detalhes</a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card shadow-none border bg-gradient-start-1 h-100">
        <div class="card-body p-20">
          ...
          <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
            <a href="{{ route('publico.servidores.publicos-ativos') }}" class="text-primary-main">Ver Detalhes</a>
          </p>
        </div>
      </div>
    </div>
