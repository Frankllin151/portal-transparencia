...
<div class="card">
  ...
  <div class="card-body">
    ...
    @foreach ($matricula as $item)
      <option value="{{ $item->nome }}" {{ $data->matricula == $item->nome? 'selected' : '' }}>
        {{ $item->nome }}
      </option>
    @endforeach
  </select>
      ...
      <div class="row gy-3">
        ...
        <div class="col-12">
          ...
          <input type="text" name="remuneracao_contratual" id="remuneracao_contratual"
                 ...
                 value="{{ old('remuneracao_contratual', number_format($data->remuneracao_contratual, 2, ',', '.')) }}"
                 placeholder="0,00" onkeyup="mascaraMoeda(this, event)" required>
        ...
        <div class="col-12">
          ...
          <input type="text" name="contribuicao_empregado_rgps" id="contribuicao_empregado_rgps"
                 ...
                 value="{{ old('contribuicao_empregado_rgps', number_format($data->contribuicao_empregado_rgps, 2, ',', '.')) }}"
                 placeholder="0,00" onkeyup="mascaraMoeda(this, event)">
        ...
        <div class="col-12">
          ...
          <input type="text" name="contribuicao_empregado_rat_fat" id="contribuicao_empregado_rat_fat"
                 ...
                 value="{{ old('contribuicao_empregado_rat_fat', number_format($data->contribuicao_empregado_rat_fat, 2, ',', '.')) }}"
                 placeholder="0,00" onkeyup="mascaraMoeda(this, event)">
        ...
        <div class="col-12">
          ...
          <input type="text" name="contribuicao_patronal_rgps" id="contribuicao_patronal_rgps"
                 ...
                 value="{{ old('contribuicao_patronal_rgps', number_format($data->contribuicao_patronal_rgps, 2, ',', '.')) }}"
                 placeholder="0,00" onkeyup="mascaraMoeda(this, event)">
        ...
        <div class="col-12">
          ...
          <input type="number" step="0.01" name="carga_horaria_semanal" id="carga_horaria_semanal"
                 ...
                 value="{{ old('carga_horaria_semanal', $data->carga_horaria_semanal) }}"
        ...
        <div class="col-12">
          ...
          <input type="number" step="0.01" name="carga_horaria_mensal" id="carga_horaria_mensal"
                 ...
                 value="{{ old('carga_horaria_mensal', $data->carga_horaria_mensal) }}"
                 placeholder="0.00">
        ...
        <div class="col-12">
          ...
          <input type="text" name="organograma" id="organograma"
                 ...
                 value="{{ old('organograma', $data->organograma) }}"
