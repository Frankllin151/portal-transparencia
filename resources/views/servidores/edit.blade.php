...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{ route('servidores.update', $data->id) }}" method="POST">
      @csrf
      @method('PUT')
    ...
    @foreach ($Entidade as $item)
      <option value="{{ $item->nome }}" {{ $data->entidade == $item->nome? 'selected' : '' }}>
        {{ $item->nome }}
      </option>
    @endforeach
  </select>
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="matricula" id="matricula" class="form-control @error('matricula') is-invalid @enderror"
                         value="{{ old('matricula', $data->matricula) }}" placeholder="Número de Matrícula" required>
                  @error('matricula')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                <div class="col-12">
                 ...
                 <select name="lotacao" class="form-select" required>
    @foreach ($lotacao as $item)
      <option value="{{ $item->nome }}" {{ $data->lotacao == $item->nome? 'selected' : '' }}>
        {{ $item->nome }}
      </option>
    @endforeach
  </select>
    ...
    @foreach ($Orgao as $item)
      <option value="{{ $item->nome }}" {{ $data->orgao == $item->nome? 'selected' : '' }}>
        {{ $item->nome }}
      </option>
    @endforeach
  </select>
                ...
                <div class="col-12">
                  ...
                  <input type="date" name="data_admissao" id="data_admissao" class="form-control @error('data_admissao') is-invalid @enderror"
                         value="{{ old('data_admissao', $data->data_admissao ? \Carbon\Carbon::parse($data->data_admissao)->format('Y-m-d') : '') }}" required>
                  @error('data_admissao')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row gy-3">
                <div class="col-12">
                  ...
                  <select name="vinculo_empregaticio" id="vinculo_empregaticio" class="form-control @error('vinculo_empregaticio') is-invalid @enderror">
                    ...
                    @foreach($vinculoEmpregaticio as $item)
                      <option value="{{ $item->nome }}" {{ old('vinculo_empregaticio', $data->vinculo_empregaticio) == $item->nome ? 'selected' : '' }}>
                        {{ $item->nome }}
                      </option>
                    @endforeach
                  </select>
                ...
                <div class="col-12">
                  ...
                  <select name="situacao" id="situacao" class="form-control @error('situacao') is-invalid @enderror" required>
                    ...
                    @foreach($situacaoCargo as $item) {{-- Reutilizando a variável situacaoCargo para a situação do servidor --}}
                ...
                <div class="col-12">
                  ...
                  <select name="classificacao_afastamento" id="classificacao_afastamento" class="form-control @error('classificacao_afastamento') is-invalid @enderror">
                    ...
                    @foreach($classificacaoAfastamento as $item)
                      <option value="{{ $item->nome }}" {{ old('classificacao_afastamento', $data->classificacao_afastamento) == $item->nome ? 'selected' : '' }}>
                        {{ $item->nome }}
                      </option>
                    @endforeach
                  </select>
                ...
                <div class="col-12">
                  ...
                  <select name="efetivo_em_cargo_comissionado" id="efetivo_em_cargo_comissionado" class="form-control @error('efetivo_em_cargo_comissionado') is-invalid @enderror">
                    ...
                    <option value="1" {{ old('efetivo_em_cargo_comissionado', $data->efetivo_em_cargo_comissionado) == '1' ? 'selected' : '' }}>Sim</option>
                    <option value="0" {{ old('efetivo_em_cargo_comissionado', $data->efetivo_em_cargo_comissionado) == '0' ? 'selected' : '' }}>Não</option>
                  </select>
                ...
                <div class="col-12">
                  ...
                  <select name="cargo_id" id="cargo_id" class="form-control @error('cargo_id') is-invalid @enderror" required>
                    ...
                    @foreach($cargos as $cargo)
                      <option value="{{ $cargo->id }}" {{ old('cargo_id', $data->cargo_id) == $cargo->id ? 'selected' : '' }}>
              ...
              <div class="row gy-3">
                <div class="col-12">
                  ...
                  <input type="number" step="0.01" name="remuneracao_contratual" id="remuneracao_contratual" class="form-control @error('remuneracao_contratual') is-invalid @enderror"
                         value="{{ old('remuneracao_contratual', $data->remuneracao_contratual) }}" placeholder="0.00" required>
                ...
                <div class="col-12">
                  ...
                  <input type="number" step="0.01" name="contribuicao_empregado_rgps" id="contribuicao_empregado_rgps" class="form-control @error('contribuicao_empregado_rgps') is-invalid @enderror"
                         value="{{ old('contribuicao_empregado_rgps', $data->contribuicao_empregado_rgps) }}" placeholder="0.00">
                ...
                <div class="col-12">
                  ...
                  <input type="number" step="0.01" name="contribuicao_empregado_rat_fat" id="contribuicao_empregado_rat_fat" class="form-control @error('contribuicao_empregado_rat_fat') is-invalid @enderror"
                         value="{{ old('contribuicao_empregado_rat_fat', $data->contribuicao_empregado_rat_fat) }}" placeholder="0.00">
                ...
                <div class="col-12">
                  ...
                  <input type="number" step="0.01" name="contribuicao_patronal_rgps" id="contribuicao_patronal_rgps" class="form-control @error('contribuicao_patronal_rgps') is-invalid @enderror"
                         value="{{ old('contribuicao_patronal_rgps', $data->contribuicao_patronal_rgps) }}" placeholder="0.00">
                ...
                <div class="col-12">
                  ...
                  <input type="number" step="0.01" name="carga_horaria_semanal" id="carga_horaria_semanal" class="form-control @error('carga_horaria_semanal') is-invalid @enderror"
                         value="{{ old('carga_horaria_semanal', $data->carga_horaria_semanal) }}" placeholder="0.00" required>
                ...
                <div class="col-12">
                  ...
                  <input type="number" step="0.01" name="carga_horaria_mensal" id="carga_horaria_mensal" class="form-control @error('carga_horaria_mensal') is-invalid @enderror"
                         value="{{ old('carga_horaria_mensal', $data->carga_horaria_mensal) }}" placeholder="0.00">
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="organograma" id="organograma" class="form-control @error('organograma') is-invalid @enderror"
                         value="{{ old('organograma', $data->organograma) }}" placeholder="Estrutura Organizacional">
                  @error('organograma')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
