...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
  ...
  <ul class="d-flex align-items-center gap-2">
    <li class="fw-medium">
     <a href="{{ route('tipoempenho') }}" class="btn btn-sm btn-secondary radius-8 d-inline-flex align-items-center gap-1">
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title mb-0">Cadastro  Tipo de Empenho</h5>
      </div>
      <div class="card-body">
        <form action="{{ route('tipoempenho.store') }}" method="POST" class="row gy-3 needs-validation" novalidate>
          @csrf
