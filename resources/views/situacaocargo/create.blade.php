...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
  <h6 class="fw-semibold mb-0"> {{ __('Situação Cargo') }}</h6> {{-- Título da seção ajustado --}}
  <ul class="d-flex align-items-center gap-2">
    <li class="fw-medium">
     <a href="{{ route('situacaocargo') }}" class="btn btn-sm btn-secondary radius-8 d-inline-flex align-items-center gap-1">
