...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{ route('movimentacaobancaria.update', $data->id) }}" method="POST">
      @csrf
      @method('PUT')
            ...
            <div class="card-body">
              <div class="row gy-3">
                <div class="col-12">
                  ...
                  <input type="text" name="nome_entidade" class="form-control" value="{{ old('nome_entidade', $data->nome_entidade) }}" placeholder="Ex: Rutherford-Botsford">
                  @error('nome_entidade') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-12">
                  <label class="form-label">Código da Conta</label>
                  <input type="text" name="codigo_conta" class="form-control" value="{{ old('codigo_conta', $data->codigo_conta) }}" placeholder="Ex: 672340">
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="tipo_conta" class="form-control" value="{{ old('tipo_conta', $data->tipo_conta) }}" placeholder="Ex: salario, corrente, poupanca">
            ...
            <div class="card-body">
              <div class="row gy-3">
                <div class="col-12">
                  ...
                  <input type="text" name="codigo_banco" class="form-control" value="{{ old('codigo_banco', $data->codigo_banco) }}" placeholder="Ex: 399">
                  @error('codigo_banco') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-12">
                  <label class="form-label">Nome do Banco</label>
                  <input type="text" name="nome_banco" class="form-control" value="{{ old('nome_banco', $data->nome_banco) }}" placeholder="Ex: Banco HSBC S.A.">
                  @error('nome_banco') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-12">
                  <label class="form-label">Número da Agência</label>
                  <input type="text" name="numero_agencia" class="form-control" value="{{ old('numero_agencia', $data->numero_agencia) }}" placeholder="Ex: 1605">
                  @error('numero_agencia') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-12">
                  <label class="form-label">Descrição da Agência</label>
                  <input type="text" name="descricao_agencia" class="form-control" value="{{ old('descricao_agencia', $data->descricao_agencia) }}" placeholder="Ex: Agência Katelinstad">
                  @error('descricao_agencia') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-12">
                  <label class="form-label">Número da Conta</label>
                  <input type="text" name="numero_conta" class="form-control" value="{{ old('numero_conta', $data->numero_conta) }}" placeholder="Ex: 44809006-3">
