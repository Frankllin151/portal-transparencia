...
<x-app-layout>
  ...
  <h6 class="fw-semibold mb-0"> {{ __('Tipo Poder') }}</h6> {{-- Título da seção ajustado --}}
  <ul class="d-flex align-items-center gap-2">
    <li class="fw-medium">
     <a href="{{ route('tipopoder') }}" class="btn btn-sm btn-secondary radius-8 d-inline-flex align-items-center gap-1">
