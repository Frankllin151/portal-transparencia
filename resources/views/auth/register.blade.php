<!-- filepath: /home/frankllin/docker/portal-transparencia/resources/views/auth/register.blade.php -->
<x-guest-layout>
        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    ...
                    <p class="mb-32 text-secondary-light text-lg">Preencha os dados abaixo para se cadastrar</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mt-32 text-center text-sm">
                        @if (Route::has('login'))
                            <p class="mb-0">Já tem uma conta? <a href="{{ route('login') }}" class="text-primary-600 fw-semibold">Entrar</a></p>
                        @endif
                    </div>
                </form>
            </div>
