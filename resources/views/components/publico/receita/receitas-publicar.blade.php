    ...
    <div class="card shadow-none border bg-gradient-start-1 h-100">
      <div class="card-body p-20">
        ...
        <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
          <a href="{{route("receita.prevista.x.realizada")}}" class="text-primary-main">Ver Detalhes</a>
        </p>
      </div>
    </div>
...
<div class="col">
    <div class="card shadow-none border bg-gradient-start-1 h-100">
      <div class="card-body p-20">
        ...
        <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
          <a href="{{route("receita.orcamentaria")}}" class="text-primary-main">Ver Detalhes</a>
        </p>
      </div>
    </div>

</div>
<!---Receitas Orçamentárias end-->
...
<!--Receitas Orçamentárias Diárias end-->
</div>
</div>