  ...
  <div class="col">
    <div class="card shadow-none border bg-gradient-start-1 h-100">
      <div class="card-body p-20">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
          <div>
            <p class="fw-medium text-primary-light mb-1">Despesas Orçamentárias</p>
            <h6 class="mb-0"></h6> </div>
  ...
  <div class="col">
    <div class="card shadow-none border bg-gradient-start-1 h-100">
      <div class="card-body p-20">
        ...
        <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
          <a href="#" class="text-primary-main">Ver Lista</a>
        </p>
      </div>
    </div></div>
  ...
  <div class="col">
    <div class="card shadow-none border bg-gradient-start-1 h-100">
      <div class="card-body p-20">
        ...
        <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
          <a href="#" class="text-primary-main">Ver Processos</a>
        </p>
      </div>
    </div></div>
  ...
  <div class="col">
    <div class="card shadow-none border bg-gradient-start-1 h-100">
      <div class="card-body p-20">
        ...
        <p class="fw-medium text-sm text-primary-light mt-12 mb-0 d-flex align-items-center gap-2">
          <a href="#" class="text-primary-main">Ver Contratos</a>
        </p>
      </div>
    </div></div>
