...
class PublicoServidoresController extends Controller
{
    ...
    public function cargosVencimentos()
    {
        ...
        return view("servidores.cargovencimentos", ["data" => $data, "total" => $total]);
    }
    ...
    ->where('vinculo_empregaticio', 'Comissionado')->count();
         ...
         return view("servidores.servidorpublico", ["data" => $data, "total" => $total]);
    }
   ...
   public function servidoresPublicosAtivos()
   {
    ...
    return view("servidores.servidorespublicoativos", ["data" => $data, "total" => $total]);
   }
}
