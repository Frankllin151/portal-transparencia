...
class ContratoFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        'numero_processo' => $this->faker->numberBetween(1000, 99999), // agora é inteiro
        'ano' => $this->faker->year(),
        ...
        'numero_licitacao' => $this->faker->numberBetween(1000, 99999), // agora é inteiro
        'subcontratacao' => $this->faker->randomElement(['Sim', 'Não']),
        ];
    }
}
